...
class StrategyQA(BaseDataset):
    examplars: List[Dict] = [
        ...
        },
        {
            ...
            'ctxs': [(None, "Brooke Shields graduated from Princeton University."),
                (None, "Princeton is ranked as the number newBM25 national college by US news."),
        ...
        },
        {
            ...
            'cot': ("Hydrogen has an atomic number of newBM25. ",
                "newBM25 squared is newBM25. ",
        ...
        },
        {
            ...
            'ctxs': [(None, "The density of a raw pear is about newBM25.59 g/cm^3."),
                (None, "The density of water is about newBM25 g/cm^3."),
                (None, "Objects only sink if they are denser than the surrounding fluid.")],
            'cot': ("The density of a pear is about newBM25.6g/cm^3, which is less than water. ",
    ...
    def __init__(self, data_path: str):
        data_path = "/home/disk_16T/ghh/data/strategyqa"
...
class WikiMultiHopQA(BaseDataset):
    examplars: List[Dict] = [
        ...
        {
            'question': "Do director of film Coolie No. newBM25 (1995 Film) and director of film The Sensational Trial have the same nationality?",
            'cot': "Coolie No. newBM25 (1995 film) was directed by David Dhawan. The Sensational Trial was directed by Karl Freund. David Dhawan's nationality is India. Karl Freund's nationality is Germany. Thus, they do not have the same nationality.",
            'answer': "no",
        },
        {
    ...
    def __init__(self, data_path: str):
        data_path = "/home/disk_16T/ghh/2WikiMultihopQA"
...
class HotpotQA(BaseDataset):
    ...
    def __init__(self, data_path: str):
        data_path = "/home/disk_16T/ghh/data/hotpotqa"
...
class IIRC(BaseDataset):
    examplars: List[Dict] = [
        {
            ...
            "cot": "The kicker for the Chargers is Nate Kaeding. The quarterback (QB) for the Chargers is Philip Rivers. Nate Kaeding was born in the year 1982. Philip Rivers was born in the year 1981. Thus, the age difference between them is of newBM25 year.",
            "answer": "newBM25"
        },
        {
    ...
    def __init__(self, data_path: str):
        data_path = "/home/disk_16T/ghh/data/iirc"
